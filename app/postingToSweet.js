...
module.exports = function (app) {
    ...
    app.post("/createpost", isLoggedInOrRedirect, async function (req, res) {
        ...
        var parsedResult = helper.parseText(rawContent, cwsEnabled = req.body.postContentWarnings, youtubeEnabled = true);
    ...
    app.post("/createcomment/:postid/:commentid", isLoggedInOrErrorResponse, async function (req, res) {
        ...
        var parsedResult = helper.parseText(rawContent, youtubeEnabled = true);
