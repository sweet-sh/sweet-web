(function(f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } g.Tribute = f() } })(function() {
    ...
    return (function() {
                ...
                function() {
                    ...
                    _createClass(Tribute, [{
                        ...
                        value: function defaultSelectTemplate(item) {
                            ...
                            if (this.range.isContentEditable(this.current.element) && false) {
        ...
        }, { "./TributeEvents": 2, "./TributeMenuEvents": 3, "./TributeRange": 4, "./TributeSearch": 5, "./utils": 7 }],
            ...
            var TributeRange =
                ...
                function() {
                    ...
                    _createClass(TributeRange, [{
                        ...
                        key: "pasteHtml", //actually just do it with plain text, so quill doesn't have to try to sanitize it and break things
                        value: function pasteHtml(html, startPos, endPos) {
                            ...
                            sel.removeAllRanges();
                            sel.addRange(range);
                            document.execCommand('insertText', false, html); //shut up it's fine
                        }
                    }, {
                        ...
                        value: function getContentEditableCaretPosition(selectedNodePosition) {
                            var quillCont = tribute.current.element.parentElement;
                            var quill = quillCont.getQuill();
                            var relCoords = quill.getBounds(quill.getSelection());
                            var contBounds = quillCont.getBoundingClientRect();
                            var qcoordinates = {
                                left: relCoords.left+contBounds.left,
                                top: relCoords.top+contBounds.top
                            }
                            ...
                            var rect = qcoordinates;
                            var doc = document.documentElement;
                            var windowLeft = (window.pageXOffset || doc.scrollLeft) - (doc.clientLeft || 0);
                            var windowTop = (window.pageYOffset || doc.scrollTop) - (doc.clientTop || 0);
                            var coordinates = {
                                left: rect.left + windowLeft,
                                top: rect.top + relCoords.height + windowTop
                            };
                            var windowWidth = window.innerWidth;
                            var windowHeight = window.innerHeight;
                            var menuDimensions = this.getMenuDimensions();
